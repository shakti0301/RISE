...
namespace GenericCollections
{
    class Program
    {
        static void Main()
        {
            ...
            //6. SortedList
            //Stores key-value pairs automatically sorted by the key. It provides fast retrieval based on keys and maintains the order of elements.
            ...
            //Check
            Console.WriteLine("\nSortedList contains key 2 : "+sL.ContainsKey(2)); //Print True
            Console.WriteLine("SortedList contains value 'Two' : "+sL.ContainsValue("Two")); //Print True

            //remove 
            sL.Remove(1); //Remove by key
            sL.RemoveAt(0); //Remove by index
            ...
            //7. LinkedList
            // A classic doubly-linked list that allows fast insertion and removal of elements. It provides methods to add, remove, and traverse the list efficiently.
            ...
            //remove
            linkedList.Remove("Node1");//Remove by value
            Console.WriteLine("\nAfter removing 'Node1' : ");
            linkedList.RemoveFirst(); //Remove first node
            linkedList.RemoveLast(); //Remove last node

            //check if linked list contains "Node2"
            Console.WriteLine("LinkedList contains 'Node2' : "+linkedList.Contains("Node2")); //Print False
            ...
            //8. StoredDictionary
            // A SortedDictionary<TKey, TValue> is a collection of key-value pairs that are sorted by the keys. It provides fast retrieval based on keys and maintains the order of elements.
